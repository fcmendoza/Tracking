...
namespace Tracking.DataAccess{
    public partial class TrackinDB{
        ...
        public StoredProcedure SaveTransaction(long? TransactionID,string Description,decimal? Amount,DateTime? Date,string Tags, string accountName = null){
            ...
            sp.Command.AddParameter("AccountName", accountName, DbType.AnsiString);
            return sp;
        }
