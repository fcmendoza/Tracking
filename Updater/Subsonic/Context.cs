...
{
	public partial class TrackinDB : IQuerySurface
	{
		...
		public TrackinDB() 
		{ 
			DataProvider = ProviderFactory.GetProvider("dasConnection");
			Init();
		}

		public TrackinDB(string connectionStringName)
		{
			DataProvider = ProviderFactory.GetProvider(connectionStringName);
			Init();
		}

		public TrackinDB(string connectionString, string providerName)
		{
